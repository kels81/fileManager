...
public final class DashboardMenu extends CustomComponent {
    ...
    private Component buildTitle() {
        Label logo = new Label("File <strong>Manager</strong>",
                ContentMode.HTML);
    ...
    private Usuarios getCurrentUser() {
        return (Usuarios) VaadinSession.getCurrent().getAttribute(
    ...
    private Component buildUserMenu() {
        ...
        final Usuarios user = getCurrentUser();
    ...
    public void updateUserName(final ProfileUpdatedEvent event) {
        ...
        settingsItem.setText(user.getuNombre() + " " + user.getuApellidoPaterno());
    }
